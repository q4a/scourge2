...
public class GameState implements WindowListener, ProgressListener {
    ...
    public GameState() {
        mainMenuWindow = new Window(Main.getMain().getScreenWidth() / 2,
                                    (int)(Main.getMain().getScreenHeight() / 4.0f * 3.0f),
                                    300, 300, this);
        ...
        gameMenuWindow = new Window(Main.getMain().getScreenWidth() / 2,
                                    (int)(Main.getMain().getScreenHeight() / 2.0f),
                                    300, 300, this);
    ...
    public void progress(final float percent) {
        Main.getMain().getGameTaskQueueManager().update(new Callable<Object>() {
