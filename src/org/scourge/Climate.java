                ...
                if((int)(Math.random() * 5) == 0) {
                    ...
                    if(dir == Direction.NORTH) {
                        region.getTile(x, y).addModel(Model.dungeonColumn,
                                             new Vector3(ShapeUtil.WALL_WIDTH / 2 - 2, 0, 0),
                                             1, 0, Vector3.UNIT_Y);
                    }
                    if(dir == Direction.SOUTH) {
                        region.getTile(x, y).addModel(Model.dungeonColumn,
                                             new Vector3(ShapeUtil.WALL_WIDTH / 2 - 2, 0, ShapeUtil.WALL_WIDTH + 1),
                                             1, 0, Vector3.UNIT_Y);
                    }
                    if(dir == Direction.WEST) {
                        region.getTile(x, y).addModel(Model.dungeonColumn,
                                             new Vector3(-1, 0, ShapeUtil.WALL_WIDTH / 2 - 2),
                                             1, 90, Vector3.UNIT_Y);
                    }
                    if(dir == Direction.EAST) {
                        region.getTile(x, y).addModel(Model.dungeonColumn,
                                             new Vector3(ShapeUtil.WALL_WIDTH + 1, 0, ShapeUtil.WALL_WIDTH / 2 - 2),
                                             1, 90, Vector3.UNIT_Y);
                    }
                }
            }
                ...
                if((int)(Math.random() * 5) == 0) {
                    ...
                    if(dir == Direction.NORTH) {
                        region.getTile(x, y).addModel(Model.dungeonColumn2,
                                             new Vector3(ShapeUtil.WALL_WIDTH / 2 - 2, 0, -1),
                                             1, 0, Vector3.UNIT_Y);
                    }
                    if(dir == Direction.SOUTH) {
                        region.getTile(x, y).addModel(Model.dungeonColumn2,
    ...
    private static void addTorch(Model torch, Direction dir, Region region, int x, int y) {
        if(dir == Direction.NORTH) {
            region.getTile(x, y).addModel(torch,
                                 new Vector3(ShapeUtil.WALL_WIDTH / 2 - 2, 10, 0),
                                 1, 180, Vector3.UNIT_Y);
        }
        if(dir == Direction.SOUTH) {
            region.getTile(x, y).addModel(torch,
                                 new Vector3(ShapeUtil.WALL_WIDTH / 2 - 2, 10, ShapeUtil.WALL_WIDTH + 1),
                                 1, 0, Vector3.UNIT_Y);
        }
        if(dir == Direction.WEST) {
            region.getTile(x, y).addModel(torch,
                                 new Vector3(-1, 10, ShapeUtil.WALL_WIDTH / 2 - 2),
                                 1, -90, Vector3.UNIT_Y);
        }
        if(dir == Direction.EAST) {
            region.getTile(x, y).addModel(torch,
                                 new Vector3(ShapeUtil.WALL_WIDTH + 1, 10, ShapeUtil.WALL_WIDTH / 2 - 2),
                                 1, 90, Vector3.UNIT_Y);
        }
    }
